...
export interface Product {
  ...
  /**
   * Базова ціна товару в гривнях, напр. 450 або 1700.
   */
  price: number;
  /**
  ...
  variants?:
    | {
        label: string;
        /**
         * На скільки грн цей варіант дорожчий (або дешевший — тоді зі знаком мінус) за базову ціну.
         */
